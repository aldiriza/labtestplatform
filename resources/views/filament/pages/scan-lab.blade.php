    ...
    <div 
        x-data="{
            ...
            async scanFile(event) {
                ...
                if (!this.scanner) this.scanner = new Html5Qrcode('reader-hidden');
        ...
        <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 overflow-hidden">
            <div class="fi-section-header flex flex-col gap-3 px-6 py-4 sm:flex-row sm:items-center sm:justify-between border-b border-gray-200 dark:border-white/10">
                <div class="flex items-center gap-4">
                    <div class="fi-icon-btn relative flex items-center justify-center rounded-lg bg-primary-50 dark:bg-primary-500/10 p-3">
                        <x-heroicon-m-beaker class="h-8 w-8 text-primary-600 dark:text-primary-400" />
                    </div>
                    <div>
            ...
            <div x-show="isCameraOpen" x-collapse>
                <div class="bg-gray-950 p-4">
                    <div id="reader" class="w-full max-w-md mx-auto rounded-lg overflow-hidden ring-2 ring-white/20"></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                    ...
                    <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 overflow-hidden">
                        ...
                        <div class="{{ $bannerColor }} px-6 py-4 text-white">
                             <div class="flex items-center justify-between">
                                <h3 class="font-bold text-xl flex items-center">
                                    ...
                                    @if($statusKey === 'arrived') CHECKED IN
                                    @elseif($statusKey === 'lab_received') IN LAB
                                    @elseif($statusKey === 'in_progress') TESTING
                                    @elseif($statusKey === 'completed') COMPLETED
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex flex-wrap gap-4 text-sm text-gray-500 dark:text-gray-400 mb-6">
                                <span class="flex items-center"><x-heroicon-m-building-storefront class="w-4 h-4 mr-1"/> {{ $scannedMaterial->supplier }}</span>
                                <span class="flex items-center"><x-heroicon-m-document-text class="w-4 h-4 mr-1"/> {{ $scannedMaterial->po_number }}</span>
                            </div>

                            {{-- Result Entry Form --}}
                            @if($statusKey === 'in_progress' && (auth()->user()->hasRole('lab') || auth()->user()->hasRole('admin')))
                                <div class="fi-section rounded-xl bg-gray-50 dark:bg-gray-800 p-6 ring-1 ring-gray-950/5 dark:ring-white/10">
                                    <h4 class="font-semibold text-gray-950 dark:text-white mb-4">Enter Validated Results</h4>
                                    <form wire:submit="submitResult">
                                        {{ $this->resultForm }}
                                        <div class="mt-6 flex justify-end">
                                            <x-filament::button type="submit" size="lg" color="success" icon="heroicon-o-check-circle">
                                                Complete Test
                                            </x-filament::button>
                                        </div>
                                    </form>
                ...
                @else
                    ...
                    <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 h-64 flex flex-col items-center justify-center text-gray-400">
                        ...
                        <span class="font-medium">Scan an item to view details</span>
                    </div>
                @endif
            </div>
            ...
            <div class="lg:col-span-1">
                 <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 p-4">
                    <h3 class="fi-section-header-heading text-sm font-semibold text-gray-950 dark:text-white mb-4">Recent Scans</h3>
